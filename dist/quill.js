...
Quill = (function(superClass) {
  ...
  function Quill(container1, options) {
    ...
    this.placeholder = this.addContainer('ql-placeholder');
    this.on(Quill.events.TEXT_CHANGE, function(delta) {
      var blank, text;
      text = this.getText();
      blank = text.length === 1 && text.charCodeAt(0) === 10;
      if (blank) {
        return this.placeholder.style.display = 'block';
      } else {
        return this.placeholder.style.display = 'none';
      }
    });
  ...
  Quill.prototype.clearUndoHistory = function() {
    var undo_manager;
  ...
  Quill.prototype.setPlaceholderText = function(text) {
    return this.placeholder.innerHTML = text;
  };
